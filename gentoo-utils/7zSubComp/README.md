...
It verifies archives after creation automatically. It can also preform extraction, viewing, size information, and removal of only subdirectories under a master directory.
